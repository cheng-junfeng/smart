...
package com.jmolsmobile.videocapture.configuration;

import android.media.MediaRecorder;
import android.os.Parcel;
import android.os.Parcelable;

import com.jmolsmobile.videocapture.configuration.PredefinedCaptureConfigurations.CaptureQuality;
import com.jmolsmobile.videocapture.configuration.PredefinedCaptureConfigurations.CaptureResolution;
...
public class CaptureConfiguration implements Parcelable {
    ...
    public CaptureConfiguration(CaptureResolution resolution, CaptureQuality quality, int maxDurationSecs, int maxFilesizeMb)
    {
