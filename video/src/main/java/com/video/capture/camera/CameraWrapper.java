...
package com.video.capture.camera;
...
import com.video.capture.camera.OpenCameraException.OpenType;
...
public class CameraWrapper {
	...
	public RecordingSize getSupportedRecordingSize(int width, int height) {
		...
		LogUtil.d(TAG, "Recording size: " + recordingSize.width + "x"
	...
	public void configureForPreview(int viewWidth, int viewHeight) {
		...
		LogUtil.d(TAG, "Preview size: " + previewSize.width + "x"
				+ previewSize.height);
	}
