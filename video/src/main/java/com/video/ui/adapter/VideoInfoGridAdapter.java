...
public class VideoInfoGridAdapter extends BaseAdapter {
    ...
    private ArrayList<VideoInfo> mImages = new ArrayList<VideoInfo>();
     ...
     * @param images
     */
    public void addData(List<VideoInfo> images) {
        mImages.clear();
     ...
     * @param image
     */
    public void addData(VideoInfo image) {
        if (image == null) {
            return;
        }
        mImages.add(image);
