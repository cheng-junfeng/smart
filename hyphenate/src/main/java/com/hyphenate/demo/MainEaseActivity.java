...
public class MainEaseActivity extends EaseBaseActivity{
    private TextView unreadLabel;
    private Button[] mTabs;
    private EaseConversationListFragment conversationListFragment;
    private EaseContactListFragment contactListFragment;
    private SettingsEaseFragment settingFragment;
    ...
    protected void onCreate(Bundle arg0) {
        ...
        settingFragment = new SettingsEaseFragment();
        ...
        conversationListFragment.setConversationListItemClickListener(new EaseConversationListItemClickListener() {
            ...
            public void onListItemClicked(EMConversation conversation) {
                startActivity(new Intent(MainEaseActivity.this, ChatEaseActivity.class).putExtra(EaseConstant.EXTRA_USER_ID, conversation.conversationId()));
            }
        });
        contactListFragment.setContactListItemClickListener(new EaseContactListItemClickListener() {
            ...
            public void onListItemClicked(EaseUser user) {
                startActivity(new Intent(MainEaseActivity.this, ChatEaseActivity.class).putExtra(EaseConstant.EXTRA_USER_ID, user.getUsername()));
            }
        });
    ...
    public void onTabClicked(View view) {
        ...
        if(viewId == R.id.btn_conversation){
            index = 0;
        }else if(viewId == R.id.btn_conversation){
            index = 1;
