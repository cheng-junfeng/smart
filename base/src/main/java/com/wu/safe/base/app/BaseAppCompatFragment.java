...
import com.wu.safe.base.listener.OnRetryListener;
...
public abstract class BaseAppCompatFragment extends RxAppCompatDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View containerView = LayoutInflater.from(getContext()).inflate(R.layout.base_fragment_root, null);
